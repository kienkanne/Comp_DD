...
def main():
    ...
    if args.command == "run_vina":
        from nexus._DOCKING.vina.vina_pipeline import VinaPipeline
        ...
        from nexus._VALIDATION.validation_coreset.validation_config import load_validation_config
        from nexus._VALIDATION.validation_coreset.rmsd import compute_validation_rmsds
        from nexus._DOCKING.vina.vina_pipeline import VinaPipeline
        ...
        from nexus._VALIDATION.validation_coreset.validation_config import load_validation_config
        from nexus._VALIDATION.validation_coreset.rmsd import compute_validation_rmsds
        from nexus._DOCKING.dock6.dock6_pipeline import DOCK6Pipeline
        ...
        from nexus.fetch.rcsb_fetch import fetch_rcsb
        from nexus.fetch.fetch_config import load_retrieval_config
