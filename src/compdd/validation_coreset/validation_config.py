from compdd.docking_configs.root_config import RootConfig, _setup_dirs
...
def load_validation_config(path):
    ...
    protein_suffix = cfg.validation.protein_suffix
    pocket_suffix = cfg.validation.pocket_suffix
    ligand_suffix = cfg.validation.ligand_suffix
